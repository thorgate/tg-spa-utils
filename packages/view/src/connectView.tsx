...
export type ViewDecoratorOptions = Pick<
    ViewProps, 'className' | 'NotFoundComponent' | 'onUserUpdate' | 'Fallback' | 'onComponentError'
>;
...
export const connectView = (options: OptionalMap<ViewDecoratorOptions> = {}) => (
    function decorator<P>(Component: ComponentType<P>) {
        ...
        WrappedComponent.displayName = `connectView(${Component.displayName || Component.name})`;
