...
export type SagaTask<Params extends Kwargs<Params> = {}> = (match: MatchWithRoute<Params>, ...args: any[]) => Iterator<any>;
...
export type SagaRunnerTask<Params extends Kwargs<Params> = {}> = Array<SagaTask<Params> | SagaTaskType<Params>>;
...
interface CallHistoryMethodAction<T extends string, M extends string, A = any[]> {
    type: T;
...
export type ConnectedRouterHistoryActions =
    CallHistoryMethodAction<CALL_HISTORY_METHOD_TYPE, 'push', [Path, LocationState?]>
    | CallHistoryMethodAction<CALL_HISTORY_METHOD_TYPE, 'push', [LocationDescriptorObject<any>]>
    | CallHistoryMethodAction<CALL_HISTORY_METHOD_TYPE, 'replace', [Path, LocationState?]>
    | CallHistoryMethodAction<CALL_HISTORY_METHOD_TYPE, 'replace', [LocationDescriptorObject<any>]>
