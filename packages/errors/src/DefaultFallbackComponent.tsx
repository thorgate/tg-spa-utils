...
import React, { ComponentType, ErrorInfo, Fragment, SFC } from 'react';
...
const DefaultErrorHandler: SFC<ErrorComponentProps & RouteComponentProps> = ({ error, errorInfo, resetError, history }) => (
