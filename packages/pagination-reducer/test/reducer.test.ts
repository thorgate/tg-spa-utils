...
const reducer = combineReducers<PaginationState, PaginationActions>({
...
describe('reducer works', () => {
    ...
    test('selectors return default', () => {
        expect(
            paginationSelectors.selectNextKwargs(store.getState(), 'test')
        ).toEqual(null);
        expect(
            paginationSelectors.selectCurrentKwargs(store.getState(), 'test')
        ).toEqual(null);
        expect(
            paginationSelectors.selectPrevKwargs(store.getState(), 'test')
        ).toEqual(null);
        expect(
            paginationSelectors.selectHasNext(store.getState(), 'test')
        ).toEqual(false);
        expect(
            paginationSelectors.selectHasPrev(store.getState(), 'test')
        ).toEqual(false);
    });
